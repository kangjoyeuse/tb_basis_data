                    ...
                    >
                        <div class="navbar-nav">
                            <a
                                ...
                                href="./index.php"
                                ><span class="fas fa-file-medical"></span> Daftar Laporan</a
                            >
                            <a href="report.php" class="nav-link active"><span class="fas fa-file-contract"></span> Report</a>
                            <?php if ($user && $user['level'] == 1): ?>
                            <a href="crudModal.php" class="nav-link active"><span class="fas fa-users"></span> Akun</a>
                            <?php endif; ?>
                        </div>
                        <div class="navbar-text ms-auto d-flex align-items-center">
                            <?php if ($user): ?>
                                ...
                                <span class="badge bg-<?= $user['level'] == 1 ? 'primary' : 'secondary'; ?>">
                                    <?= $user['level'] == 1 ? '<span class="fas fa-user-shield"></span> Admin' : '<span class="fas fa-user"></span> Operator '; ?>
                                </span>
                                <a href="./logout.php" class="nav-link active ms-3"><span class="fa fa-sign-out"></span> Log Out</a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
